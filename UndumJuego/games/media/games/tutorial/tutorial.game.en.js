...
undum.game.situations = {
    start: new undum.SimpleSituation(
		...
		como maestro a Sakonji Urokodaki, un antiguo cazador de demonios.\</p>\
        \
        <p class='transient'>Urokodaki te propone  <a href='reto'>un reto...\
        </a></p>"
    ),
	...
	reto: new undum.SimpleSituation(
        ...
        <img class='img-situation' src='./media/img/fin.jpeg'>\
			...
			NOseQue la cual está llena de peligros y partir en dos la roca gigante\
			que hay en la cima.</p>\
			<p>Pasan los dias y no consigues partir la roca, lo cual te genera\
			desmotivacion y frustracion. Tienes 3 opciones:\
			1. Harto de la roca decides ir directamente a la prueba.\
			2. Pese a tu pesimismo decides seguir entrenando.\
			3. Decides llorarle a tu maestro Urokodaki para que para él la roca.\</p>\
			<h1>Fin</h1>",
        {
